	...
	<main id="main" class="site-main" role="main">
		...
		?>
			...
			<div class="page-breadcrumbs-wrapper pb-without-bg">
				...
				$address =  nl2br(get_post_meta(284, 'address', true));
				$emailAddress = get_post_meta(284, 'emailAddress', true);
				$phoneNumber = nl2br(get_post_meta(284, 'phoneNumber', true));
				...
				<div class="container">
					...
					<div class="row col-p30">
						<div class="col-sm-12">
							...
							<h3>
							<?php 
								$customerCat = get_term_by('id', 21, 'division-type');
		...
		<h3>
		<?php
			$intOfficeCat = get_term_by('id', 22, 'division-type'); 
