...
function themify_manage_links( $data = array() ) {
    ...
    $field_ids_json = themify_get( $pre.'field_ids' );
    if ($field_ids_json !== null) {
        $field_ids = json_decode( $field_ids_json, true ); // Decode JSON to an associative array
    } else {
        $field_ids = $start;
    }
        ...
        $out = '<p>
                    ...
                    <select name="' . esc_attr( $key . 'by' ) . '">';
                        foreach ( $orderby_options as $option => $value ) {
                            $out .= '<option value="' . esc_attr( $value ) . '" '.selected( $orderby, $value, false ).'>' . esc_html( $option ) . '</option>';
                            }
        $out .= '    </select>
                </p>
                <p>
                    ...
                    <select name="' . esc_attr( $key ) . '">';
                        foreach ( $order_options as $option => $value ) {
                            $out .= '<option value="' . esc_attr( $value ) . '" '.selected( $order, $value, false ).'>' . esc_html( $option ) . '</option>';
                    }
        $out .= '    </select>
                </p>';
