...
500));this.listenTo(this.model,"custom:preview:reload",this.previewReload);this.listenTo(this,"custom:preview:init",this.previewInit)},createEl:function(a,e){0<this.$(".module").length?this.$(".module").replaceWith(a):this.el.insertAdjacentHTML("beforeend",a);this.$el.children("style").remove();_.isObject(e)&&_.keys(e).length&&this.render_stylesheet(this.model.cid,e)},previewLive:function(a){this._jqueryXhr&&4!==this._jqueryXhr&&this._jqueryXhr.abort();this._shortcodeXhr&&4!==this._shortcodeXhr&&
this._shortcodeXhr.abort();a=this.templateVisual(a);var e=g.Utils.shortcodeToHTML(a);_.isEmpty(e.tags)||(a=e.content);0<this.$(".module").length?this.$(".module").replaceWith(a):this.el.insertAdjacentHTML("beforeend",a);this.$el.children("style").remove();g.liveStylingInstance.$liveStyledElmt=this.$(".module");_.isEmpty(e.tags)||g.activeModel.trigger("custom:preview:sc",e.tags)},previewLiveCallback:function(){console.log("previewLiveCallback");g.Utils.loadContentJs();c("body").trigger("builder_load_module_partial",
this.$el)},previewInit:function(){g.activeModel.trigger("custom:preview:reload")},previewReload:function(){var a=this;this._jqueryXhr&&4!==this._jqueryXhr&&this._jqueryXhr.abort();this._shortcodeXhr&&4!==this._shortcodeXhr&&this._shortcodeXhr.abort();this._jqueryXhr=c.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tfb_load_module_partial",tfb_post_id:this.$el.closest(".themify_builder_content").data("postid"),tfb_cid:this.model.cid,tfb_module_slug:this.model.get("mod_name"),
tfb_module_data:JSON.stringify(this.model.getPreviewSettings()),tfb_load_nonce:themifyBuilder.tfb_load_nonce},beforeSend:function(e){a.$el.addClass("themify-builder-component-preview-loading")},success:function(e){a.createEl(e.html);g.liveStylingInstance.$liveStyledElmt=a.$(".module");"undefined"!==typeof WebFont&&0<e.gfonts.length&&WebFont.load({google:{families:e.gfonts}});g.Utils.loadContentJs(a.$el);g.Frontend.responsiveFrame.doSync();a.$el.removeClass("themify-builder-component-preview-loading");
...
null,ThemifyBuilderModuleJs.init(),ThemifyBuilderCommon.showLoader("spinhide"),c("body").trigger("builder_toggle_frontend",a));g.Utils.columnDrag(null,!1);setTimeout(function(){c("body").trigger("builder_finished_loading")},2E3)}})};g.render=function(a){0<a.length&&(c.each(a,function(e,b){var d="#themify_builder_content-"+a[e].builder_id,f=c(d),h=new g.Collections.Rows(a[e].builder_data);f.wrapInner('<div class="themify_builder_content_remove_wrapper" />');g.Instances.Builder[e]=new g.Views.Builder({el:d,
collection:h,type:"visual"});g.Instances.Builder[e].render();f.find(".themify_builder_content_remove_wrapper").nextAll().addClass("hide-builder-content")}),ThemifyBuilderCommon.showLoader("show"),g.bootstrap(function(){c.each(a,function(e,b){c("#themify_builder_content-"+a[e].builder_id).find(".themify_builder_content_remove_wrapper").remove().end().find(".hide-builder-content").removeClass("hide-builder-content")});ThemifyBuilderCommon.showLoader("spinhide");c("body").trigger("builder_toggle_frontend",
!0);g.Utils.loadContentJs();g.vent.trigger("dom:builder:change")}));c("#themify_builder_switch_backend").on("click",this.switchBackEnd)};g.switchBackEnd=function(a){a.preventDefault();var e=c(this).attr("href");ThemifyBuilderCommon.undoManager.instance.hasUndo()&&e?g.Utils.saveBuilder(!0,function(){ThemifyBuilderCommon.undoManager.instance.clear();window.location=e}):window.location=e;sessionStorage.setItem("focusBackendEditor",!0)};g.initFrontend=function(){g.Views.bindEvents();g.Forms.bindEvents();
this.toolbar=new g.Views.Toolbar({el:"#tb_toolbar"});this.liveStylingInstance=new ThemifyLiveStyling;tbLocalScript.isAnimationActive&&Themify.LoadCss(tbLocalScript.builder_url+"/css/animate.min.css")};c("body").on("builderscriptsloaded.themify",function(a){g.initFrontend();g.toggleFrontEdit(a);c(".toggle_tf_builder a:first, a.js-turn-on-builder").on("click",g.toggleFrontEdit.bind(g))}).on("builderiframeloaded.themify",function(a){g.Frontend.responsiveFrame.init()});ThemifyLiveStyling=function(a,e){function b(){this.$context=
a("#themify_builder_lightbox_parent");this.elmtSelector="#builder_live_styled_elmt";this.isInit=!1;this.style_tab=".themify_builder_style_tab";this.selectorQueue=[];this.data=[];var d=this;a("body").on("builderiframeloaded.themify",function(f){a(".themify_builder_site_canvas").css("width",a(window).width());d.iframe=g.Frontend.responsiveFrame.contentWindow;d.bindLightboxForm();a(document).trigger("tfb.live_styling.after_create",d)})}b.prototype.init=function(d,f){this.remove();this.$liveStyledElmt=
d;this.currentStyleObj="object"===typeof f?f:{};this.isInit=!0;a(document).trigger("tfb.live_styling.after_init",this)};b.prototype.setLiveStyledElmtID=function(){this.$liveStyledElmt.prop("id",this.elmtSelector.substring(1))};b.prototype.unsetLiveStyledElmtID=function(){this.$liveStyledElmt.prop("id",!1);a("#"+this.elmtSelector.substring(1)).prop("id",!1)};b.prototype.isModuleExists=function(a){return this.data["module-inner"]&&this.data["module-inner"][a]?!0:!1};b.prototype.isComponentExists=function(a){return this.data[a]?
!0:!1};b.prototype.addStyleDate=function(a,f){this.isComponentExists[a]||(this.data[a]=f)};b.prototype.convertToPX=function(d,f){var b=parseInt(f),e=f.match(/\D{1,2}$/);e[0]&&"%"===e[0]?b=a(d).outerWidth()*b/100:e[0]&&"em"===e[0]&&(b*=parseInt(a(d).css("fontSize")));return b};b.prototype.setLiveStyle=function(d,f){f||(f=[""]);var b=".themify_builder .tb_element_cid_"+g.activeModel.cid,e="module"===g.activeModel.get("elType")?" ":"",c=this;f.forEach(function(f){f=f&&0<f.length?b+e+f.trim():b;g.styleSheet.setStyles(f,
d);if(a(f).hasClass("fullwidth")){var h=a(tbLocalScript.fullwidth_container),n=a(f).closest(".themify_builder_content"),p=n.offset().left-h.offset().left,n=h.outerWidth()-p-n.outerWidth(),q=a(f).data("padding"),k=a(f).data("margin");q&&(d["padding-left"]&&(a(f).css({paddingLeft:""}),q[0]=c.convertToPX(f,d["padding-left"])),d["padding-right"]&&(a(f).css({paddingRight:""}),q[1]=c.convertToPX(f,d["padding-right"])),(d["padding-left"]||d["padding-right"])&&a(f).data("padding",q));k&&(d["margin-left"]&&
(k[0]=c.convertToPX(f,d["margin-left"]),a(f).css({marginLeft:-p+k[0]})),d["margin-right"]&&(k[1]=c.convertToPX(f,d["margin-right"]),a(f).css({marginRight:-n+k[1]})),d["margin-left"]||d["margin-right"])&&(a(f).css({width:h.outerWidth()-(k[0]+k[1])+"px"}),a(f).data("margin",k))}});g.Frontend.responsiveFrame.doSync()};b.prototype.bindColors=function(){var d=this;this.$context.on("change","input.colordisplay",function(){var d=0<a(this).val().length?"#"+a(this).val():"",b=a(this).parent().find(".builderColorSelectInput").prop("name");
a("body").trigger("themify_builder_color_picker_change",[b,d])});this.$context.on("change","input.color_opacity",function(){var d=a(this).val(),b="#"+a(this).parent().find(".colordisplay").prop("value"),e=a(this).parent().find(".builderColorSelectInput").prop("name"),b=(b=/^#([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})$/.exec(b))?"rgba("+parseInt(b[1],16)+", "+parseInt(b[2],16)+", "+parseInt(b[3],16)+", "+d+")":"";a(this).parent().find(".builderColorSelectInput").prop("value",a(this).parent().find(".colordisplay").prop("value")+
"_"+d);a("body").trigger("themify_builder_color_picker_change",[e,b])});a("body").on("themify_builder_color_picker_change",function(f,b,e){if("cover_color"===b)b=d.$context.find('input[name="'+b+'-type"]:checked'),"color"!==b.val()&&"hover_color"!==b.val()||d.addOrRemoveComponentOverlay(e,!1);else if(d.isInit){f=a('input[name="'+b+'"]');if(0<f.next(".style_border").length&&f.closest(".themify_builder_field").nextAll(".themify_builder_field").last().find(".style_apply_all_border").is(":checked"))return!1;
b=d.getValue(b);f=b.selector;var c={};b&&(c[b.prop]=e,d.setLiveStyle(c,f))}})};b.prototype.overlayType=function(){this.$context.on("change",'input[name="cover_color-type"]',function(){"color"===a(this).val()?a('input[name="cover_color"]',this.$context).prev().trigger("change"):a("#"+a(this).val()+"-gradient-type").trigger("change")})};b.prototype.getSpecialTextSelectors=function(){return" h1; h2; h3:not(.module-title); h4; h5; h6".split(";")};b.prototype.addOrRemoveComponentOverlay=function(d,f){var e=
b.getComponentBgOverlay(this.$liveStyledElmt);if(d.length){var c=0!==e.length;c||(e=a("<div/>",{"class":"builder_row_cover"}));e.data("color",d);e.attr("data-color-val",d);f?e.css({background:d,"background-color":""}):e.css({"background-image":"",background:d});if(!c){c=b.getComponentBgSlider(this.$liveStyledElmt);if(!c.length){var c="",g=ThemifyBuilderCommon.getComponentType(this.$liveStyledElmt);if("row"===g)c=".row_inner_wrapper";else if("col"===g||"sub-col"===g)c=".tb-column-inner";c=this.$liveStyledElmt.children(c)}e.insertBefore(c)}}else e.remove()};
b.prototype.bindTextInputs=function(){var d=this;a("body").delegate(d.style_tab+' input[type="text"]',"keyup",function(){var f=a(this).prop("id"),b=d.getValue(f),e={};if(b){var c=a.trim(a(this).val());if(0<a("#"+f+"_unit").length&&""!==c)c+=a("#"+f+"_unit").val()?a("#"+f+"_unit").val():"px";else if(a(this).hasClass("style_border")){if(a(this).closest(".themify_builder_field").nextAll(".themify_builder_field").last().find(".style_apply_all_border").is(":checked"))return!1;(c=parseFloat(c))?(a(this).closest(".themify_builder_field").find("select").trigger("change"),
c=c.toString()):c="0";c+="px"}else a(this).hasClass("style_field_px")&&(c+="px",a(this).closest(".themify_builder_field").find("select").length&&a(this).closest(".themify_builder_field").find("select").trigger("change"));e[b.prop]=c;d.setLiveStyle(e,b.selector)}});a("body").delegate(d.style_tab+' [id$="_unit"]',"change",function(){var d=a(this).prop("id").replace("_unit","");a("#"+d).trigger("keyup")})};b.prototype.bindRowWidthHeight=function(){var d=this;this.$context.on("change",'input[name="row_height"]',
function(){var f=d.getStylingVal("row_height"),b=a(this).val();0<b.length?(0<f.length&&d.$liveStyledElmt.removeClass(f),d.setStylingVal(a(this).prop("name"),b),d.$liveStyledElmt.addClass(b)):d.$liveStyledElmt.removeClass(f)});this.$context.on("change",'input[name="row_width"]',function(){d.getStylingVal("row_width");var f=a(this).val();"fullwidth"==f?(d.$liveStyledElmt.removeClass("fullwidth").addClass("fullwidth_row_container"),""==tbLocalScript.fullwidth_support&&ThemifyBuilderModuleJs.setupFullwidthRows()):
"fullwidth-content"==f?(d.$liveStyledElmt.removeClass("fullwidth_row_container").addClass("fullwidth"),""==tbLocalScript.fullwidth_support&&ThemifyBuilderModuleJs.setupFullwidthRows()):(d.$liveStyledElmt.removeClass("fullwidth fullwidth_row_container"),""==tbLocalScript.fullwidth_support&&d.$liveStyledElmt.css({"margin-left":"","margin-right":"","padding-left":"","padding-right":"",width:""}));a("body").trigger("builderfullwidth.themify",[d.$liveStyledElmt])})};b.prototype.removeAnimations=function(a,
f){f.removeClass(a+" wow animated").css("animation-name","")};b.prototype.addAnimation=function(a,f){f.addClass(a+" animated")};b.prototype.bindAnimation=function(){var d=this;this.$context.on("change","#animation_effect",function(){var f=d.getStylingVal("animation_effect");a(this).val().length?(f.length&&d.removeAnimations(f,d.$liveStyledElmt),f=a(this).val(),d.setStylingVal("animation_effect",f),d.addAnimation(f,d.$liveStyledElmt)):d.removeAnimations(f,d.$liveStyledElmt)})};b.prototype.bindAdditionalCSSClass=
function(){var d=this;this.$context.on("keyup","#custom_css_row, #custom_css_column",function(){var f=this.id,b=d.getStylingVal(f);d.$liveStyledElmt.removeClass(b);b=a(this).val();d.setStylingVal(f,b);d.$liveStyledElmt.addClass(b)})};b.prototype.bindRowAnchor=function(){var d=this;this.$context.on("keyup","#row_anchor",function(){var f=d.getStylingVal("row_anchor");d.$liveStyledElmt.removeClass(d.getRowAnchorClass(f));f=a(this).val();d.setStylingVal("row_anchor",f);d.$liveStyledElmt.addClass(d.getRowAnchorClass(f))})};
b.prototype.getRowAnchorClass=function(a){return 0<a.length?"tb_section-"+a:""};b.prototype.getStylingVal=function(a){return this.currentStyleObj.hasOwnProperty(a)?this.currentStyleObj[a]:""};b.prototype.setStylingVal=function(a,f){this.currentStyleObj[a]=f};b.prototype.bindBackgroundMode=function(){var d=this;this.$context.on("change","#background_repeat",function(){var f=d.getStylingVal("background_repeat"),b=a(this).val();b&&0<b.length?(0<f.length&&d.$liveStyledElmt.removeClass(f),d.setStylingVal("background_repeat",
b),d.$liveStyledElmt.addClass(b)):d.$liveStyledElmt.removeClass(f)})};b.prototype.bindBackgroundPosition=function(){var d=this;this.$context.on("change","#background_position",function(){var b=d.getStylingVal("background_position"),c=a(this).val();c&&0<c.length?(0<b.length&&d.$liveStyledElmt.removeClass(b),c="bg-position-"+c,d.setStylingVal("background_position",c),d.$liveStyledElmt.addClass(c)):d.$liveStyledElmt.removeClass(b)})};b.prototype.isWebSafeFont=function(a){return-1!==themifyBuilder.webSafeFonts.indexOf(a)};
b.prototype.bindBackgroundSlider=function(){var d=function(){return{shortcode:encodeURIComponent(a("#background_slider").val()),mode:a("#background_slider_mode").val(),size:a("#background_slider_size").val(),order:ThemifyBuilderCommon.getComponentOrder(this.$liveStyledElmt),type:ThemifyBuilderCommon.getComponentType(this.$liveStyledElmt)}}.bind(this);var f=function(a){var d=ThemifyBuilderCommon.getComponentType(this.$liveStyledElmt),f=b.getComponentBgOverlay(this.$liveStyledElmt);f.length?f.after(a):
"row"==d?this.$liveStyledElmt.children(".themify_builder_row_top").after(a):this.$liveStyledElmt.prepend(a)}.bind(this);var c=function(a){ThemifyBuilderModuleJs.backgroundSlider(a)};var e=this;this.$context.on("change","#background_slider, #background_slider_mode,#background_slider_size",function(){b.removeBgSlider(e.$liveStyledElmt);a("#background_slider").val().length&&a.post(themifyBuilder.ajaxurl,{nonce:themifyBuilder.tfb_load_nonce,action:"tfb_slider_live_styling",tfb_background_slider_data:d()}).done(function(d){10>
d.length||(d=a(d),f(d),c(a(d.get(0))))})})};b.prototype.VideoOptions=function(){var d=this;this.$context.on("change",'input[name="background_video_options"]',function(){if(d.isInit){var b=d.$liveStyledElmt.children(".big-video-wrap").first(),c="";if(b.hasClass("themify_ytb_wrapper"))b=b.closest("[data-fullwidthvideo]"),0<b.length&&(c="ytb");else if(b.hasClass("themify-video-vmieo"))(b=$f(b.children("iframe")[0]))&&(c="vimeo");else if(b=b.closest("[data-fullwidthvideo]").data("video"))b=b.getPlayer(),
c="local";"mute"===a(this).val()?a(this).is(":checked")?"ytb"===c?b.ThemifyYTBMute():"vimeo"===c?b.api("setVolume",0):"local"===c&&b.muted(!0):"ytb"===c?b.ThemifyYTBUnmute():"vimeo"===c?b.api("setVolume",1):"local"===c&&b.muted(!1):"unloop"===a(this).val()&&(a(this).is(":checked")?"vimeo"===c?b.api("setLoop",0):"local"===c&&b.loop(!1):"vimeo"===c?b.api("setLoop",1):"local"===c&&b.loop(!0))}})};b.prototype.bindBackgroundTypeRadio=function(){var d=this;this.$context.on("change",'input[name="background_type"]',
function(){if(d.isInit){var c=ThemifyBuilderCommon.getCheckedRadioInGroup(a(this),d.$context).val();"image"===c||"gradient"===c?(b.removeBgSlider(d.$liveStyledElmt),b.removeBgVideo(d.$liveStyledElmt),"image"===c?d.setLiveStyle({"background-image":"none"},[""]):c+="-gradient-angle"):"video"===c?b.removeBgSlider(d.$liveStyledElmt):(b.removeBgVideo(d.$liveStyledElmt),d.setLiveStyle({"background-image":"none"},[""]));d.$context.find("#background_"+c).trigger("change")}})};b.prototype.bindBackgroundGradient=
function(a,b,c){function d(){if("undefined"===typeof d.pre){var a=window.getComputedStyle(document.documentElement,"");d.pre=(Array.prototype.slice.call(a).join("").match(/-(moz|webkit|ms)-/)||""===a.OLink&&["","o"])[1]}return d.pre}if(this.isInit){var e=this.getValue(a),f={};if(e){b=b.replace(/background-image:/ig,"").split(";");var g={moz:0,webkit:4,o:2,ms:3};a=d();b=g[a]&&b[g[a]]?b[g[a]]:b[4];if(c)return b;f[e.prop]=b;this.setLiveStyle(f,e.selector)}}};b.prototype.bindModuleLayout=function(){var d=
this,b={layout_feature:"",layout_menu:"ul.ui.nav:first"};Object.keys(b).forEach(function(c){d.$context.on("click","#"+c+" > a",function(){var e=a(this).attr("id"),f=d.$liveStyledElmt;""!==b[c]&&(f=d.$liveStyledElmt.find(b[c]));var g=d.getStylingVal(c);"layout_feature"===c&&(e="layout-"+e,g="layout-"+g);f.removeClass(g).addClass(e);"layout_feature"===c&&(e=e.substr(7));d.setStylingVal(c,e)})})};b.prototype.bindModuleRadio=function(){var b=this,c={buttons_style:"> .module-buttons",buttons_size:"> .module-buttons",
icon_style:"> .module-icon",icon_size:"> .module-icon",icon_arrangement:"> .module-icon"};Object.keys(c).forEach(function(d){b.$context.on("change","#"+d+' input[type="radio"]',function(){if(b.$liveStyledElmt){var e=a(this).val(),f=""!==c[d]?b.$liveStyledElmt.find(c[d]):b.$liveStyledElmt,g=b.getStylingVal(d);f.removeClass(g).addClass(e);b.setStylingVal(d,e)}})})};b.prototype.bindModuleColor=function(){var b=this,c={color_menu:"ul.ui.nav:first",mod_color_pricing_table:["","> .module-pricing-table-header",
".module-pricing-table-button"],icon_color_bg:"> .module-icon i"},e=Object.keys(c).reduce(function(a,b,d){0!==d&&(a+=",");return a+("#"+b+" > a")},"");b.$context.on("click",e,function(){var d=a(this),e=d.parent().attr("id"),f=a(this).attr("id"),g=d.closest(".themify_builder_row_js_wrapper"),h=c[e];Array.isArray(h)||(h=[h]);var l=a([]);h.forEach(function(a){l=""===a?l.add(b.$liveStyledElmt):l.add(b.$liveStyledElmt.find(a))});if(0<g.length){var m=d.closest(".themify_builder_row").index();var k=e;e+=
"_"+m;l=a(l[m])}d=b.getStylingVal(e);!d&&0<g.length&&(g=b.getStylingVal(g.attr("id")),g[m]&&g[m][k]&&(d=g[m][k]));l.removeClass(d).addClass(f);b.setStylingVal(e,f)})};b.prototype.setApplyBorder=function(b,c,e){var d=this.getValue(b),f={};d&&("color"===e&&"rgba(0, 0, 0, 1)"===c&&(c="",""===a("#"+b.replace("color","width")).val()&&(f["border-style"]="")),f["border-"+e]="width"===e?0<c?c+"px":"":c,this.setLiveStyle(f,d.selector))};b.prototype.bindChangesEvent=function(){var d=this;a("body").delegate(d.style_tab+
" select,"+d.style_tab+' input[type="radio"],'+d.style_tab+" .themify-builder-uploader-input","change",function(){if(d.isInit){var c=a(this).is("select")||a(this).hasClass("themify-builder-uploader-input")?a(this).prop("id"):a(this).parent(".tfb_lb_option").prop("id"),c=d.getValue(c),e={};if(c){var g=a(this).val(),p=c.selector;if(!_.isNull(g)){if(a(this).hasClass("font-family-select"))"default"===g||d.isWebSafeFont(g)?"default"===g&&(g=""):ThemifyBuilderCommon.loadGoogleFonts([g.split(" ").join("+")+
":400,700:latin,latin-ext"],d.iframe);else if(a(this).hasClass("themify-builder-uploader-input"))if(0<a(this).closest(".themify_builder_input").find(".thumb_preview").length)g=g?"url("+g+")":"none";else return d.$liveStyledElmt.data("fullwidthvideo",g),0<g.length?ThemifyBuilderModuleJs.fullwidthVideo(d.$liveStyledElmt):b.removeBgVideo(d.$liveStyledElmt),!1;else if(!a(this).hasClass("style_field_select")&&a(this).is("select")&&0<a(this).find('[value="dashed"]').length&&("none"!==g&&!parseInt(a(this).closest(".themify_builder_input").find(".style_border").val())||
a(this).closest(".themify_builder_field").nextAll(".themify_builder_field").last().find(".style_apply_all_border").is(":checked")))return!1;e[c.prop]=g;d.setLiveStyle(e,p)}}}})};b.prototype.getValue=function(b){if(this.isInit){var d=ThemifyBuilderCommon.getComponentType(this.$liveStyledElmt);_.contains(["sub-col","col"],d)&&(d="column");return"module-inner"===d?(d=a(this.style_tab).data("module"))&&this.data[d]&&this.data[d][b]?this.data[d][b]:!1:this.data[d]&&this.data[d][b]?this.data[d][b]:!1}return!1};
b.prototype.bindModuleApppearance=function(){var b=this,c=function(d){return b.$context.find("#"+d+" > input:checked").map(function(b,d){return a(d).val()}).toArray().join(" ")},e={accordion_appearance_accordion:"> ul.ui.module-accordion",appearance_button:"> .ui.builder_button",appearance_callout:"",action_btn_appearance_callout:".callout-button a",according_style_menu:"ul.ui.nav:first",mod_appearance_pricing_table:["","> .module-pricing-table-header",".module-pricing-table-button"]},g=Object.keys(e).reduce(function(a,
b,d){0!==d&&(a+=",");return a+("#"+b+" > input")},"");b.$context.on("change",g,function(){var d=a(this).parent().attr("id"),f=e[d];Array.isArray(f)||(f=[f]);var g=a([]);f.forEach(function(a){g=""===a?g.add(b.$liveStyledElmt):g.add(b.$liveStyledElmt.find(a))});var f=b.getStylingVal(d).split("|").join(" "),h=c(d);"mod_appearance_pricing_table"===d&&(f+=" "+f.split(" ").join("|"),h+=" "+h.split(" ").join("|"));g.removeClass(f).addClass(h);b.setStylingVal(d,c(d).split(" ").join("|"))})};b.prototype.bindLightboxForm=
