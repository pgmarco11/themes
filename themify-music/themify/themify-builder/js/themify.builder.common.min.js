var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,e,h){b instanceof String&&(b=String(b));for(var l=b.length,a=0;a<l;a++){var c=b[a];if(e.call(h,c,a,b))return{i:a,v:c}}return{i:-1,v:void 0}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(b,e,h){b!=Array.prototype&&b!=Object.prototype&&(b[e]=h.value)};$jscomp.getGlobal=function(b){return"undefined"!=typeof window&&window===b?b:"undefined"!=typeof global&&null!=global?global:b};
$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(b,e,h,l){if(e){h=$jscomp.global;b=b.split(".");for(l=0;l<b.length-1;l++){var a=b[l];a in h||(h[a]={});h=h[a]}b=b[b.length-1];l=h[b];e=e(l);e!=l&&null!=e&&$jscomp.defineProperty(h,b,{configurable:!0,writable:!0,value:e})}};$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(b,h){return $jscomp.findInternal(this,b,h).v}},"es6-impl","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
...
$jscomp.iteratorPrototype=function(b){$jscomp.initSymbolIterator();b={next:b};b[$jscomp.global.Symbol.iterator]=function(){return this};return b};$jscomp.iteratorFromArray=function(b,e){$jscomp.initSymbolIterator();b instanceof String&&(b+="");var h=0,l={next:function(){if(h<b.length){var a=h++;return{value:e(a,b[a]),done:!1}}l.next=function(){return{done:!0,value:void 0}};return l.next()}};l[Symbol.iterator]=function(){return l};return l};
...
return 2<a.length&&"null"!=a?JSON.parse(a):""},getRowStylingSettings:function(a){a=a.find(".row_inner").children(".row-data-styling").data("styling");return"object"===typeof a?a:!1},getSubRowStylingSettings:function(a){a=a.children(".subrow-data-styling").data("styling");return"object"===typeof a?a:!1},getColumnStylingSettings:function(a){a=a.children(".column-data-styling").data("styling");return"object"===typeof a?a:!1},findColumnInNewRow:function(a,b){var c=null;if(b.hasOwnProperty("sub-col_index")){var f=
b["sub-col_index"];c=b.col_index;c=a.find(".themify_builder_row_content > .themify_builder_col:nth-child("+(c+1)+")").find(".themify_builder_sub_row_content > .themify_builder_col:nth-child("+(f+1)+")")}else b.hasOwnProperty("col_index")&&(c=b.col_index,c=a.find(".themify_builder_row_content > .themify_builder_col:nth-child("+(c+1)+")"));return c},getCheckedRadioInGroup:function(a,c){"undefined"===typeof c&&(c=null);var d=a.attr("name");return b('input:radio[name="'+d+'"]:checked',c)},loadGoogleFonts:function(a,
b){b=b||!1;var c={google:{families:a}};WebFont.load(c);b&&(c.context=b,WebFont.load(c))},autoComplete:function(){if(0<b(".themify_tax_autocomplete").length){var a=[];b(".themify_tax_autocomplete").each(function(){var c=b(this),d=c.closest(".themify_builder_input").find("input.query_category_multiple"),f=d.val();b(this).autocomplete({minLength:2,source:function(a,d){var f=b.trim(a.term);b.getJSON(themifyBuilder.ajaxurl,{term:b.trim(f),tax:c.data("tax"),action:c.data("action")},function(a,b,c){d(a)})},
select:function(a,b){d.val(b.item.value);this.value=b.item.label;return!1}}).focus(function(){b(this).autocomplete("search");return!1});if(f&&"undefined"!==f){var g={};g[c.data("tax")]=f;a.push(g)}else d.val("")});a&&b.ajax({url:themifyBuilder.ajaxurl,type:"POST",dataType:"json",data:{data:a,action:"themify_builder_get_tax_data"},success:function(a){if(a)for(var c in a)b("#themify_search_cat_"+a[c].tax).val(a[c].val)}})}},hideShowBackgroundZoom:function(a){function c(c){var d=b("#background_zoom",
...
hoverClass:"themify-combo-hover",selectedClass:"themify-combo-selected",markerClass:"themify-combo-marker"}).parent("div");c.on("comboselect:close",function(){b(".themify_builder_font_preview").hide()});c.trigger("focusin");b(".themify-combo-item",c).unbind("hover").hover(function(){var d=b(this).data("value");if(d&&b(this).is(":visible")){var e=c.next(".themify_builder_font_preview");"default"===d&&(d="inherit");e.css({top:b(this).position().top+30,"font-family":d,display:"block"});if("inherit"!==
d&&!b(this).hasClass("themify_builder_font_loaded")){var h=b(this),k=h.index();h.addClass("themify_builder_font_loaded");e=e.children("span");-1===b.inArray(d,g.fonts)&&(e.addClass("themify_show_wait"),"webfont"!==a.find('option[value="'+d+'"]').data("type")?WebFont.load({google:{families:[d]},fontloading:function(a,b){g.fonts.push(d);e.removeClass("themify_show_wait")},fontinactive:function(a,b){g.fonts.push(d);e.removeClass("themify_show_wait")}}):(g.fonts.push(d),e.removeClass("themify_show_wait")));
f(k,d,e)}}})}function f(a,c){b(".themify-combo-dropdown").find("li:eq("+a+")").addClass("themify_builder_font_loaded").css("font-family",c)}this.autoComplete();this.hideShowBorder(a);this.hideShowSliderArrow(a);this.hideShowBackgroundZoom(a);var g=ThemifyBuilderCommon,k="",h="";if(0===Object.keys(g.safe_fonts).length){for(var e in themify_builder_plupload_init.fonts.safe)""!==themify_builder_plupload_init.fonts.safe[e].value&&"default"!==themify_builder_plupload_init.fonts.safe[e].value&&(g.safe_fonts[themify_builder_plupload_init.fonts.safe[e].value]=
themify_builder_plupload_init.fonts.safe[e].name);for(e in themify_builder_plupload_init.fonts.google)""!==themify_builder_plupload_init.fonts.google[e].value&&"default"!==themify_builder_plupload_init.fonts.google[e].value&&(g.google_fonts[themify_builder_plupload_init.fonts.google[e].value]=themify_builder_plupload_init.fonts.google[e].name)}b(".font-family-select",a).each(function(){var a=b(this).prop("name"),f=c&&c[a]?c[a]:!1,e=b(this).find("optgroup");b(this).parent(".themify_builder_font_preview_wrapper").focusin(function(){b(this).unbind("focusin");
if(!k){for(var a in g.safe_fonts){var c=f===a?'selected="selected"':"";k+="<option "+c+' data-type="webfont" value="'+a+'">'+g.safe_fonts[a]+"</option>"}for(a in g.google_fonts)c=f===a?'selected="selected"':"",h+="<option "+c+' value="'+a+'">'+g.google_fonts[a]+"</option>"}e.first().html(k);e.last().html(h);d(b(this).children("select"))});f&&(g.safe_fonts[f]?e.first().html('<option selected="selected" data-type="webfont" value="'+f+'">'+g.safe_fonts[f]+"</option>"):g.google_fonts[f]&&e.last().html('<option selected="selected"  value="'+
f+'">'+g.google_fonts[f]+"</option>"))});if(0<g.fonts.length){var l=b(".themify-combo-dropdown").first();for(e in g.fonts){var m=l.find('[data-value="'+g.fonts[e]+'"]').index();f(m,g.fonts[e])}}b(".themify-combo-arrow").unbind("click").click(function(){b(".themify_builder_font_preview").hide()})},Lightbox:{$lightbox:null,setup:function(){function a(){750<parseInt(c.$lightbox.width())?c.$lightbox.addClass("larger-lightbox"):c.$lightbox.removeClass("larger-lightbox")}var c=ThemifyBuilderCommon.Lightbox,
...
(function(){c.$lightbox.on("dragstop resizestop",function(a,b){var d={top:b.position.top,left:b.position.left,width:c.$lightbox.outerWidth(),height:c.$lightbox.outerHeight()},f="themify_builder_lightbox_frontend_pos_size";ThemifyBuilderCommon.isFrontend()||(f="themify_builder_lightbox_backend_pos_size");localStorage.setItem(f,JSON.stringify(d))})})()},bindEvents:function(){var a=ThemifyBuilderCommon.Lightbox,c=b("body"),d="true"==themifyBuilder.isTouch?"touchend":"click";c.on("editing_row_option editing_column_option editing_module_option editing_subrow_option",
...
a.clickCheckboxOption).on(d,'#tfb_module_settings input[type="text"], #tfb_module_settings textarea',a.focusInput).on("change","#tfb_module_settings .query_category_single",function(){b(this).closest(".themify_builder_input").find(".query_category_multiple").val(b(this).val())}).on(d,".reset-styling",a.resetStyling);b(e).on("scroll",ThemifyBuilderCommon.tinyMCEMenuFix);themifyBuilder.disableShortcuts||a.controlByKeyInput()},adjustHeight:function(a){ThemifyBuilderCommon.Lightbox.$lightbox.find(".themify_builder_options_tab_wrapper").css("height",
a-55)},fixContainment:function(){var a=ThemifyBuilderCommon.Lightbox,c=a.$lightbox.outerWidth(),d=b(e).width(),f=b(e).height(),c=[-c+20,0,d-20,f-30],d=a.$lightbox.position(),f={};d.left<c[0]&&(f.left=c[0]);0>d.top&&(f.top=0);d.left>c[2]&&(f.left=c[2]);d.top>c[3]&&(f.top=c[3]);a.$lightbox.css(f);ThemifyBuilderCommon.tinyMCEMenuFix()},open:function(a,c){var d=ThemifyBuilderCommon.Lightbox,f=b("#themify_builder_lightbox_container");ThemifyBuilderCommon.isFrontend()&&themifybuilderapp.Frontend.hideModulesControl();
themifybuilderapp.toolbar.trigger("hide-distraction-panel");this._cleanLightBoxContent();d.$lightbox.addClass("tfb-lightbox-open");b("#themify_builder_overlay").show();ThemifyBuilderCommon.showLoader("show");if(a.loadMethod&&"inline"===a.loadMethod){var g=ThemifyBuilderCommon.templateCache.get("tmpl-"+a.templateID);d.openCallback(g,f,c)}else a.data=_.extend(a.data||{},{nonce:themifyBuilder.tfb_load_nonce}),a=_.defaults(a||{},{type:"POST",url:themifyBuilder.ajaxurl}),b.ajax(a).done(function(a){d.openCallback(a,
f,c)})},openCallback:function(a,c,d){var f=ThemifyBuilderCommon.Lightbox,g="themify_builder_lightbox_frontend_pos_size";ThemifyBuilderCommon.isFrontend()||(g="themify_builder_lightbox_backend_pos_size");var k=localStorage.getItem(g),g={top:100,left:Math.max(0,b(e).width()/2-300),width:600,height:500};null!==k&&(g=JSON.parse(k));f.$lightbox.show().css({top:g.top,left:g.left,width:g.width,height:g.height}).addClass("animated fadeIn").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
function(a){f.fixContainment();b(this).removeClass("animated fadeIn")});b(h).on("keyup",f.cancelKeyListener);ThemifyBuilderCommon.showLoader("spinhide");a=b(a);k=a.find("#themify_builder_lightbox_options_tab_items");0<k.length&&(b(".themify_builder_options_tab").append(k.children()),k.remove());k=a.find("#themify_builder_lightbox_actions_items");0<k.length&&(b(".themify_builder_lightbox_actions").append(k.children()),k.remove());c.append(a);f.$lightbox.find(".themify_builder_options_tab_wrapper").each(function(){var a=
new SimpleBar(this);b(a.getScrollElement()).on("scroll",ThemifyBuilderCommon.tinyMCEMenuFix)});f.adjustHeight(g.height);f.$lightbox.show();b("#themify_builder_lightbox_container").find("select").not(".font-family-select").wrap('<div class="selectwrapper"></div>');b(".selectwrapper").click(function(){b(this).toggleClass("clicked")});b.isFunction(d)&&d.call(this,a[0]);ThemifyBuilderCommon.setUpTooltip()},close:function(){var a=ThemifyBuilderCommon.Lightbox,c=b("form#tfb_module_settings");b(h).off("keyup",
a.cancelKeyListener);"undefined"!==typeof tinyMCE&&c.find(".tfb_lb_wp_editor").each(function(){var a=b(this).prop("id");switchEditors.go(a,"tmce");themifybuilderapp.Views.ControlRegistry.lookup(a).resetEditor()});ThemifyBuilderCommon.isFrontend()&&(a.forgetRow(),null!==themifybuilderapp.liveStylingInstance&&themifybuilderapp.liveStylingInstance.remove(),themifybuilderapp.Frontend.showColumnsBorder());themifybuilderapp.toolbar.trigger("show-distraction-panel");a.$lightbox.fadeOut(function(c){b(this).removeClass("animated fadeOut");
a._cleanLightBoxContent();b("#themify_builder_overlay, #themify_builder_lightbox_parent").hide();a.$lightbox.removeClass("tfb-lightbox-open");themifybuilderapp.vent.trigger("dom:builder:change")})},_cleanLightBoxContent:function(){b("#themify_builder_lightbox_container").children().remove().end().empty();this.$lightbox.find(".themify_builder_options_tab").empty();this.$lightbox.find(".themify_builder_lightbox_actions").children().not(".builder_cancel_lightbox").remove()},controlByKeyInput:function(){b(h).on("keydown",
function(a){if(83==a.which&&(1==a.ctrlKey||1==a.metaKey)){var c=h.activeElement.tagName.toLowerCase();if("input"!=c&&"textarea"!=c){a.preventDefault();c=b("#builder_submit_module_settings");var d=b("#builder_submit_row_settings"),f=b("#builder_submit_subrow_settings"),g=b("#builder_submit_column_settings"),e=b("#tb_toolbar").find(".tb_toolbar_save");0<c.length?c.trigger("click"):0<d.length?d.trigger("click"):0<f.length?f.trigger("click"):0<g.length?g.trigger("click"):0<e.length&&e.is(":visible")&&
e.trigger("click")}}90==a.which&&(1==a.ctrlKey&&1==a.shiftKey||1==a.metaKey&&1==a.shiftKey)?(c=h.activeElement.tagName.toLowerCase(),"input"!=c&&"textarea"!=c&&(a.preventDefault(),b(".js-themify-builder-redo-btn").length&&b(".js-themify-builder-redo-btn").trigger("click"))):90!=a.which||1!=a.ctrlKey&&1!=a.metaKey||(c=h.activeElement.tagName.toLowerCase(),"input"!=c&&"textarea"!=c&&(a.preventDefault(),b(".js-themify-builder-undo-btn").length&&b(".js-themify-builder-undo-btn").trigger("click")))})},
...
(c=c.find("a").attr("href"),a.handleDisplayOfPreviewBtn(c))},handleDisplayOfPreviewBtn:function(a){var b=ThemifyBuilderCommon.Lightbox;"#themify_builder_options_setting"===a?b.showPreviewBtn():b.hidePreviewBtn()}},undoManager:{instance:new UndoManager,events:b({}),startValue:null,startData:{},startStyleValue:null,set:function(a,b,d,f,g,e){if(!_.isNull(e)&&_.isObject(e)){var c=e.startValue;var h=e.newValue}ThemifyBuilderCommon.undoManager.instance.add({undo:function(){a[0].innerHTML=b;themifybuilderapp.vent.trigger("dom:observer:update",
a);if(!_.isEmpty(f)){var d=themifybuilderapp.Models.Registry.lookup(f.cid);d&&(d.set(f.value,{silent:!0}),d.unset("temp_settings",{silent:!0}))}_.isUndefined(c)||themifybuilderapp.styleSheet.replaceCSSText(c)},redo:function(){a[0].innerHTML=d;themifybuilderapp.vent.trigger("dom:observer:update",a);if(!_.isEmpty(g)){var b=themifybuilderapp.Models.Registry.lookup(g.cid);b&&(b.set(g.value,{silent:!0}),b.unset("temp_settings",{silent:!0}))}_.isUndefined(h)||themifybuilderapp.styleSheet.replaceCSSText(h)}});
...
a?null:d)})},alert:function(a){ThemifyBuilderCommon.LiteLightbox.confirm(a,null,{buttons:{yes:{label:"OK"}}})}},getDomPath:function(a){for(var b=[];null!=a.parentNode;){for(var d=0,f=0,e=0;e<a.parentNode.childNodes.length;e++){var h=a.parentNode.childNodes[e];h.nodeName==a.nodeName&&(h===a&&(f=d),d++)}a.hasAttribute("id")&&""!=a.id?b.unshift(a.nodeName.toLowerCase()+"#"+a.id):1<d?b.unshift(a.nodeName.toLowerCase()+":eq("+f+")"):b.unshift(a.nodeName.toLowerCase());a=a.parentNode}return b.slice(1)},
