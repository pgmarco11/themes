...
$event_id = get_post_meta($post->ID, 'speaker_event_id', true);
$imageurl = get_post_meta($post->ID, "image_speaker_url", true);
$image_id = get_post_meta($post->ID, 'image_speaker_id', true);
...
<div id="tribe-events-content" class="tribe-events-single container mb40">
	...
	<div class="row event-speaker pb-4">
		...
		<div class="col-sm-9 speaker-info">
			...
			<div class="speaker-profile full-width">
				<h1 class="mb-0 py-0" ><?php echo get_the_title(); ?></h1>
				...
				<div class="profile-details">
					...
					<div class="about">
						<?php if ( !empty($about) ): ?>
						<label class="mb-0">About <?php the_title(); ?></label>
						<p><?php 
