		...
		<div class="shows-wrap widthfull mx-2">		
			...
			<div class="row">
				...
				<div class="row mx-auto">
						<div id="now-playing" class="d-flex w-100 align-items-center justify-content-center mt-4 mb-5">
								<img src="<?php echo get_template_directory_uri() ?>/images/left-new.svg" title="Arctic playhouse upcoming shows"
								class="mr-2 left-img" />
									<h2 class="my-4 text-center">Now Playing</h2>
						...
						<?php get_template_part('/inner/featured-show-page'); ?>
				</div>
				<div class="row mx-auto">

					<div id="shows-coming" class="w-100">
						<div class="d-flex w-100 align-items-center justify-content-center mt-4 mb-5">	
								<img src="<?php echo get_template_directory_uri() ?>/images/left-new.svg" title="Arctic playhouse upcoming shows"
								class="mr-2 left-img" />
									<h2 class="my-4 text-center">Upcoming Shows</h2>
								<img src="<?php echo get_template_directory_uri() ?>/images/right-new.svg" title="Arctic playhouse upcoming shows"
								class="ml-2 right-img" />
						</div>						

						<?php get_template_part('/inner/upcoming-shows-page'); ?>
						
						<div id="events" class="d-flex w-100 align-items-center justify-content-center mt-4 mb-5">		
							<img src="<?php echo get_template_directory_uri() ?>/images/left-new.svg" title="Arctic playhouse upcoming shows"
							class="mr-2 left-img" />
								<h2 class="my-4 text-center">Upcoming Events</h2>
							<img src="<?php echo get_template_directory_uri() ?>/images/right-new.svg" title="Arctic playhouse upcoming shows"
							class="ml-2 right-img" />
						</div>											
						
						<?php get_template_part('/inner/upcoming-events-page'); ?>
