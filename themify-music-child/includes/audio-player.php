		...
		<div class="tracklist<?php if($type):?> themify_player_<?php echo $type?><?php endif;?>">
			<?php
                        ...
                        if($type=='songs'){
                            ...
                            $footer_autoplay = themify_check( 'setting-audio_player_autoplay_songs' ) ? 'preload="auto" autoplay="yes"' : '';
                            $images = 1;
                        }
                        elseif($type=='code'){
                            ...
                            for ( $track = 1; $track <= apply_filters( 'themify_theme_number_of_tracks', 12 ); $track++ ) {
                                    $list = '';
