<?php
/**
 *Template Name: Floor Safety Residential
 *
 * @package OnePress
 */
						       ...
						       global $post;					
							    ...
							    if ( $featured_images != NULL ){
							        foreach( $featured_images as $images ):
							            ...
							            echo '<img src="'.$mediumSizedImage.'" class="attachment-medium size-onepress-small wp-post-image" alt="residential floors">';
							      	endforeach;
		...
		<div id="secondary" class="container no-sidebar">
			<div class="content-area">
					...
					<div id="safety-secondary">
						...
						<?php get_sidebar('safety-residential'); ?>
