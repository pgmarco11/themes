        ...
        <section id="testimonials" class="testimonials-section">
            ...
            <div class="container">
                ...
                <div class="section-title-area">
                    ...
                    <h5 class="section-subtitle"><?php echo get_post_meta($post->ID, 'testimonials-subtitle', true); ?></h5> 
                    <h2 class="section-title"><?php echo get_post_meta($post->ID, 'testimonials-title', true); ?></h2>                                    
   
                </div>
    
                <div class="row">
                    <?php echo do_shortcode('[sola_testimonial_slider]'); ?>
                </div>
